 ...
 * Given an arr of size n, find the majority element.
 * The majority element is the element that appears more than ⌊ n/2 ⌋ times.
 * 
 * You may assume that the arr is non-empty and the majority element ALWAYS exist in the arr.
 * 
 * @author xu
 *
...
public class MajorityElement1 {
	 ...
	 * 
	 * The base case is that when the arr has only one element, then it is the majority one.
	 */
