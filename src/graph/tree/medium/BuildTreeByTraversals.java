 ...
 * @author xu
 * <p>
 * Given in-order and post-order traversal of a graph.tree, construct the binary graph.tree.
 * Note: You may assume that duplicates do not exist in the graph.tree.
 * <p>
...
public class BuildTreeByTraversals {
    ...
    /**
     * construct graph.tree from given pre-order and in-order traversals.
     */
