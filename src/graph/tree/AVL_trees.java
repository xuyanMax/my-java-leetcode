...
/**
 * This class is the complete and tested implementation of an AVL-graph.tree.
 */
...
/***************************** Core Functions ************************************/
    /**
     * Add a new element with key "k" into the graph.tree.
     *
    ...
    /**
     * Recursive method to insert a node into a graph.tree.
     *
    ...
    public void insertAVL(AvlNode p, AvlNode q) {
        // If  node to compare is null, the node is inserted. If the root is null, it is the root of the graph.tree.
        if (p == null) {
            this.root = q;
        } else {
    ...
    /**
     * Check the balance for each node recursively and call required methods for balancing the graph.tree until the root is reached.
     *
    ...
    /**
     * Removes a node from the graph.tree, if it is existent.
     */
    ...
    public void removeAVL(AvlNode p, int q) {
        if (p == null) {
            ...
            if (p.key > q) {
                ...
                // we found the node in the graph.tree.. now lets go on!
                removeFoundNode(p);
            }
        }
    }
     ...
     * @return The root of the rotated graph.tree.
     */
     ...
     *
     * @param n The node for the rotation
     * @return The root of the new rotated graph.tree.
     */
...
/***************************** Helper Functions ************************************/
    ...
    /**
     * Returns the successor of a given node in the graph.tree (search recursively).
     *
...
// }
    ...
    /**
     * Calculates the In-order traversal of this graph.tree.
     *
     * @return An Array-List of the graph.tree in in-order traversal.
     */
     ...
     * @param io The list to save the in-order traversal.
     */
