 ...
 * which is O(h) where h is height of the graph.tree. Since AVL graph.tree is balanced, the height is O(Logn).
 * So time complexity of AVL insert is O(Logn).
 * <p>
 * <p>
 * Comparison with Red Black Tree
 * The AVL graph.tree and other self balancing search trees like Red Black are useful to get all basic
 ...
 * then AVL graph.tree should be preferred over Red Black Tree.
 * <p>
 * <p>
 * Tushar:
