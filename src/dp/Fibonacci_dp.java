...
public class Fibonacci_dp {
    ...
    /**
     * dp programming -- fibonacci
     * memoize version
     * dp replaces recursion
     * O(n) time
     */
    static int fibonacci(int n, int[] dp) {
        ...
        dp[n] = f;// dp[3:] can be updated, so we need base dp[0:2]
     ...
     * O(n) time
     * constant space, from bottom-up dp-algo, you see what you really need to store
