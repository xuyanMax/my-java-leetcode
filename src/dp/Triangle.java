...
public class Triangle {
	 ...
	 * Bottom-up DP
	 * 
	 * we start from the nodes on the bottom row; the minimum pathsums for these nodes are the values of the nodes themselves
	 ...
	 * 
	 * or better, since minPath[k+1][] would be useless after minPath[k][] is calculated (O(n^2)), so we can simply set minPath[] to 1D array.
	...
	/*
	 * input data and transform the data into Lists of List 
	 */
